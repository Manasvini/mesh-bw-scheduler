...
type NetMonitorClient interface {
	...
	GetHeadroomInfo(ctx context.Context, in *HeadroomInfoRequest, opts ...grpc.CallOption) (*NetInfoReply, error)
}
...
func (c *netMonitorClient) GetHeadroomInfo(ctx context.Context, in *HeadroomInfoRequest, opts ...grpc.CallOption) (*NetInfoReply, error) {
	out := new(NetInfoReply)
	err := c.cc.Invoke(ctx, "/netmon.NetMonitor/GetHeadroomInfo", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type NetMonitorServer interface {
	...
	GetHeadroomInfo(context.Context, *HeadroomInfoRequest) (*NetInfoReply, error)
...
func (UnimplementedNetMonitorServer) GetHeadroomInfo(context.Context, *HeadroomInfoRequest) (*NetInfoReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetHeadroomInfo not implemented")
}
...
func _NetMonitor_GetHeadroomInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(HeadroomInfoRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(NetMonitorServer).GetHeadroomInfo(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/netmon.NetMonitor/GetHeadroomInfo",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(NetMonitorServer).GetHeadroomInfo(ctx, req.(*HeadroomInfoRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var NetMonitor_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetHeadroomInfo",
			Handler:    _NetMonitor_GetHeadroomInfo_Handler,
		},
	},
